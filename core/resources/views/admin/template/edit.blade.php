        ...
        <div class="card b-radius--10 shadow-sm">
            <div class="card-header bg--primary text-white py-3">
                <h5 class="card-title text-white mb-0 d-flex align-items-center">
                    <i class="las la-edit me-2 fs-4"></i> @lang('Edit WhatsApp Message Template')
                </h5>
            </div>
            <form action="{{ route('admin.templates.update', $template->id) }}" method="POST">
                ...
                <div class="card-body p-4">
                    <div class="row gy-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="category" class="form-control" value="{{ old('category', $template->category) }}">
                        </div>

                        <div class="col-12">
                            <label class="fw-bold mb-1">@lang('Message Content') <span class="text--danger">*</span></label>
                            <textarea name="message" id="template_message" rows="6" class="form-control" required>{{ old('message', $template->message) }}</textarea>
                ...
                <div class="card-footer bg-light p-3 d-flex justify-content-between align-items-center">
                    ...
                    <button type="submit" class="btn btn--primary btn-sm px-4 fw-bold">
                        <i class="las la-save me-1"></i> @lang('Update Template')
                    </button>
                </div>
            </form>
        </div>
